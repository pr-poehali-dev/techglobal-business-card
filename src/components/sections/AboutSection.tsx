      ...
      <div className="container mx-auto px-4">
        <div className="max-w-3xl mx-auto text-center mb-16">
          ...
          <p className="text-lg text-muted-foreground">
            Мы специализируемся на поставках и продаже спецтехники, промышленного оборудования и материалов напрямую от производителей из Китайской Народной Республики. За 10 лет работы мы реализовали множество крупных проектов и заслужили доверие наших клиентов.
          </p>
        </div>
