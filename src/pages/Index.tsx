  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <section className="py-20 bg-background">
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-foreground mb-4">Подробнее о нашем оборудовании</h2>
            <p className="text-lg text-muted-foreground">
              Детальная информация о категориях техники и их применении
            </p>
          </div>
          ...
          <div className="space-y-8 max-w-5xl mx-auto">
            <Card className="p-8 hover:shadow-lg transition-shadow">
              <div className="flex items-start gap-6">
                ...
                <div>
                  <h3 className="text-2xl font-semibold mb-3">Генераторное оборудование</h3>
                  <p className="text-muted-foreground mb-4">
                    Поставляем дизельные и газовые генераторы мощностью от 10 кВт до 3000 кВт от ведущих производителей: Weichai, Cummins China, Shanghai Diesel Engine.
                  </p>
                  <ul className="space-y-2 text-muted-foreground">
                    <li className="flex items-start gap-2">
                      <Icon name="CheckCircle" className="text-primary flex-shrink-0 mt-0.5" size={18} />
                      <span>Автоматический запуск при отключении основного питания</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <Icon name="CheckCircle" className="text-primary flex-shrink-0 mt-0.5" size={18} />
                      <span>Низкий расход топлива и высокая надёжность работы</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <Icon name="CheckCircle" className="text-primary flex-shrink-0 mt-0.5" size={18} />
                      <span>Применение: стройплощадки, производственные объекты, больницы, ЦОДы</span>
                    </li>
                  </ul>
                </div>
              </div>
            ...
            <Card className="p-8 hover:shadow-lg transition-shadow">
              <div className="flex items-start gap-6">
                ...
                <div>
                  <h3 className="text-2xl font-semibold mb-3">Строительная техника</h3>
                  <p className="text-muted-foreground mb-4">
                    Полный спектр строительной спецтехники от мировых брендов XCMG, Sany, Zoomlion, Liugong. Экскаваторы, бульдозеры, погрузчики для любых объёмов работ.
                  </p>
                  <ul className="space-y-2 text-muted-foreground">
                    <li className="flex items-start gap-2">
                      <Icon name="CheckCircle" className="text-primary flex-shrink-0 mt-0.5" size={18} />
                      <span>Экскаваторы массой от 1,5 до 90 тонн</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <Icon name="CheckCircle" className="text-primary flex-shrink-0 mt-0.5" size={18} />
                      <span>Бульдозеры мощностью от 130 до 520 л.с.</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <Icon name="CheckCircle" className="text-primary flex-shrink-0 mt-0.5" size={18} />
                      <span>Гарантия до 3 лет, полное сервисное обслуживание</span>
                    </li>
                  </ul>
                </div>
              </div>
            ...
            <Card className="p-8 hover:shadow-lg transition-shadow">
              <div className="flex items-start gap-6">
                ...
                <div>
                  <h3 className="text-2xl font-semibold mb-3">Грузовая и дорожная техника</h3>
                  <p className="text-muted-foreground mb-4">
                    Тягачи, самосвалы JAC, SHACMAN, FAW грузоподъёмностью до 80 тонн. Дорожные катки, асфальтоукладчики, фрезы для строительства и ремонта дорог.
                  </p>
                  <ul className="space-y-2 text-muted-foreground">
                    <li className="flex items-start gap-2">
                      <Icon name="CheckCircle" className="text-primary flex-shrink-0 mt-0.5" size={18} />
                      <span>Тягачи с двигателями мощностью 300-600 л.с.</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <Icon name="CheckCircle" className="text-primary flex-shrink-0 mt-0.5" size={18} />
                      <span>Дорожные катки массой от 12 до 26 тонн</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <Icon name="CheckCircle" className="text-primary flex-shrink-0 mt-0.5" size={18} />
                      <span>Сертификация для эксплуатации в РФ</span>
                    </li>
                  </ul>
                </div>
              </div>
            ...
            <Card className="p-8 hover:shadow-lg transition-shadow">
              <div className="flex items-start gap-6">
                ...
                <div>
                  <h3 className="text-2xl font-semibold mb-3">Грузоподъёмное оборудование</h3>
                  <p className="text-muted-foreground mb-4">
                    Автокраны, башенные краны, козловые краны XCMG грузоподъёмностью от 25 до 1200 тонн. Вилочные погрузчики от 1,5 до 45 тонн.
                  </p>
                  <ul className="space-y-2 text-muted-foreground">
                    <li className="flex items-start gap-2">
                      <Icon name="CheckCircle" className="text-primary flex-shrink-0 mt-0.5" size={18} />
                      <span>Автокраны с телескопической стрелой до 100 метров</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <Icon name="CheckCircle" className="text-primary flex-shrink-0 mt-0.5" size={18} />
                      <span>Современные системы безопасности и управления</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <Icon name="CheckCircle" className="text-primary flex-shrink-0 mt-0.5" size={18} />
                      <span>Обучение операторов и технического персонала</span>
                    </li>
                  </ul>
                </div>
              </div>
              ...
              <Card className="p-6 hover:shadow-lg transition-shadow">
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-muted-foreground">
                      Заключаем официальный договор поставки. Гибкие условия оплаты: предоплата, рассрочка. Полное юридическое сопровождение.
                    </p>
                  </div>
                </div>
              </Card>
